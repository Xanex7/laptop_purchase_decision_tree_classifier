...
<nav class="navbar">
    ...
    <div style="display: flex; align-items: center; gap: 14px;">
        ...
        <div class="nav-tag" style="display: none; @media(min-width: 640px){display: block;}">
            <i class="fa-solid fa-microchip"></i> Decision Tree Core
        </div>
    </div>
</nav>
    ...
    <div class="grid-layout">
        ...
        <div class="glass-card">
            <div class="section-header">
                ...
                <span style="font-size: 0.8rem; color: var(--text-sub);">5 Parameters Configured</span>
            </div>
            ...
            <div class="glass-card">
                ...
                <div class="valuation-card" id="resultCard">
                    ...
                    <div class="feature-badge-grid">
                        <div class="f-badge">
                            <div class="f-badge-title">Split Depth</div>
                            <div class="f-badge-val">Optimal</div>
                        </div>
                        <div class="f-badge">
                            <div class="f-badge-title">Criterion</div>
                            <div class="f-badge-val">Gini Impurity</div>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-top: 24px;">
                    ...
                    <div class="history-box">
                        <table class="history-table">
                            ...
                            <tbody id="historyLog">
                                <tr>
                                    <td colspan="4" style="color: var(--text-sub); text-align: center;">No predictions logged.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<footer>
    &copy; 2026 DecisionCore AI Platform &bull; Powered by DecisionTree Serverless Architecture
</footer>
...
<script>
    ...
    function addHistoryRecord(time, age, income, result) {
        ...
        historyRecords.forEach(rec => {
            ...
            const resultClass = rec.result === 'Class 1' ? 'tag-low' : 'tag-high';
            tr.innerHTML = `
                <td>${rec.time}</td>
                <td>${rec.age}</td>
                <td>${rec.income}</td>
    ...
    function downloadPDFReport() {
        ...
        doc.text("Date: " + new Date().toLocaleDateString() + " | Ref ID: #" + Math.floor(Math.random()*899999+100000), 20, 30);
        ...
        doc.setFontSize(11);
        doc.setFont("helvetica", "normal");
        doc.text("Confidence Score: " + document.getElementById('probLabel').textContent, 20, 60);
        
        doc.line(20, 70, 190, 70);
        doc.setFontSize(9);
        doc.text("Disclaimer: Predicted output generated via Decision Tree Classifier split algorithms.", 20, 80);
